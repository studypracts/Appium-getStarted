...
public class StartChrome {
	...
	public void test1() throws MalformedURLException, InterruptedException {
		...
		capabilities.setCapability(MobileCapabilityType.DEVICE_NAME, "Google Nexus 5X-8.0");

		// set the android version as well
		capabilities.setCapability(MobileCapabilityType.VERSION, "8.0");

		// Create object of URL class and specify the appium server address 0.0.0.0:4723
